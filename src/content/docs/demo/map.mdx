...
- A running Minecraft server (`1.21.1`)
- The Among Us in Minecraft plugin installed
- The files below:

| File                           | Download                                                                                               |
|--------------------------------|--------------------------------------------------------------------------------------------------------|
| Map (`polus.zip`)              | [Download](https://among-us-in-minecraft.docs.fantamomo.com/polus.zip)                                 |
| Area file (`f4facaf7-...json`) | [Download](https://among-us-in-minecraft.docs.fantamomo.com/f4facaf7-046f-40ec-9cc3-0ed13f965655.json) |
