...
<Steps>
    1. Open the settings menu (`/au settings` or the redstone item in your hotbar)
...
<Steps>
    1. Open the settings menu using `/au settings` or via the redstone item in your hotbar
